                ...
                <div className="cursor-pointer rounded-lg my-auto">  
                    <div className="flex">                    
                        ...
                        <div className="flex justify-between md:inline-flex items-center ml-2">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-[0.6rem] h-[0.6rem] fill-current ml-2" viewBox="0 0 24 24"><path d="M0 7.33l2.829-2.83 9.175 9.339 9.167-9.339 2.829 2.83-11.996 12.17z"></path></svg>
                        </div>
                    </div>
                </div>
            </div>          
